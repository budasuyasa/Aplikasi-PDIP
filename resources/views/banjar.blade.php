...
<div class="container mb-3">
  <div class="row">
    ...
    <div class="col d-flex justify-content-end align-items-center">
      ...
      <a href="/tambahbanjar/{{ $banjar[0]->desa->id }}" type="button" class="btn btn-success">Tambah Banjar</a>
      @else
  ...
  @elseif($message = Session::get('updatebanjar'))
  <div class="alert alert-success" role="alert">
    {{ $message }}
  </div>
  @endif
...
<div class="container bg-white shadow p-3 rounded">
  <div class="row d-flex justify-content-end align-items-center">
    ...
    <table class="table-striped w-100 table-sm">
      <thead class="table-success align-items-center">
        <tr>
          ...
          <th scope="col">Nama Kelihan Banjar</th>
    ...
    <tr>
      ...
      <td>{{ $bjr->desa->nama_desa}}</td>
      <td>{{ $bjr->nama_banjar }}</td>
      <td>{{ $bjr->kelihan_banjar}}</td>
      ...
      <td> 
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="/deletebanjar/{{ $bjr->id }}">Hapus banjar</a>
        </div>
      </div>
    </td>
    </tr>

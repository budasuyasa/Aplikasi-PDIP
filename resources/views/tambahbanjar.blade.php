...
<div class="row justify-content-center">
    <div class="col-8 ">
        <div class="card ">
            <div class="card-body">
                <form action="/insertbanjar" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="hidden" name="desa_id" value="{{ $data->id }}" readonly>
                            <input class="form-control" id="nama_kab" type="text" value="{{ $data->nama_desa }}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Nama Banjar</label>

                            <input type="text" class="form-control" name="nama_banjar">
                        </div>
                        <div class="form-group">
                            <label for="">Nama Kelihan Banjar</label>

                            <input type="text" class="form-control" name="kelihan_banjar">
                        </div>
                        <div class="form-group">
                            <label for="">Nomor Telepon Banjar</label>

                            <input type="text" class="form-control" name="notelp_kelihan">
                        </div>
